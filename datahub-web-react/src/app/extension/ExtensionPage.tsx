...
const VIEW_ENTITY_PAGE = 'VIEW_ENTITY_PAGE';

const ExtensionPageWrapper = styled.div`
    max-height: 100%;
    overflow: auto;
    padding: 16px;
`;
...
export default function ExtensionPage({ entityType }: Props) {
    ...
    return (
        <CompactContext.Provider value>
            ...
            <ExtensionPageWrapper>{entityRegistry.renderExtensionProfile(entityType, urn)}</ExtensionPageWrapper>
